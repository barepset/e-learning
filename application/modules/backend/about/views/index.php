		  ...
		  <table id="dt_basic" class="table table-bordered table-striped dataTable dt-responsive">
				<thead>
					<tr>
						...
						<th data-class="expand">About Description</th>		
						<th>Action</th>
					</tr>
					 <?php
	           $no=0;
           ...
           ?>
			...
			<tbody>
				<tr>
					...
					<td><?php echo $no; ?></td>
					<td class="sorting_1"><?php echo $obj['about_desc'] ?></td>
          <td>
          	<a href="<?=base_url(); ?>backend/about/ubah/<?php echo $obj['id_about']; ?>"class='btn btn-xs btn-flat btn-info'>Ubah</a>
            <a href="javascript:if(confirm('Apakah Anda Yakin Menghapus Data ini  ?')){document.location='<?php echo base_url(); ?>backend/about/hapus/<?php echo $obj['id_about']; ?>';}" class='btn btn-flat btn-xs btn-danger'>Hapus</a>
          </td>
				</tr>
			</tbody>
				<?php
